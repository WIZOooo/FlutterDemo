...
class ScrollExtraSpaceHomePage extends StatefulWidget {
  ScrollExtraSpaceHomePage({Key? key, required this.title}) : super(key: key);
  final String title;

  @override
  _ScrollExtraSpaceHomePageState createState() => _ScrollExtraSpaceHomePageState();
}

class _ScrollExtraSpaceHomePageState extends State<ScrollExtraSpaceHomePage> with SingleTickerProviderStateMixin {
