...
//
//
// /// Signature used by [CustomNestedScrollView] for building its header.
// ///
...
// /// to expand.
// ///
// /// [CustomNestedScrollView] solves this problem by providing custom
...
// ///
// /// This example shows a [CustomNestedScrollView] whose header is the combination of a
...
// /// {@end-tool}
// ///
// /// ## [SliverAppBar]s with [CustomNestedScrollView]s
// ///
// /// Using a [SliverAppBar] in the outer scroll view, or [headerSliverBuilder],
// /// of a [CustomNestedScrollView] may require special configurations in order to work
// /// as it would if the outer and inner were one single scroll view, like a
// /// [CustomScrollView].
// ///
// /// ### Pinned [SliverAppBar]s
// ///
// /// A pinned [SliverAppBar] works in a [CustomNestedScrollView] exactly as it would in
...
// ///
// /// This works naturally in a [CustomNestedScrollView], as the pinned [SliverAppBar]
...
// ///
// /// In order to float the outer, use [CustomNestedScrollView.floatHeaderSlivers]. When
...
// /// {@tool sample --template=stateless_widget_material}
// ///
// /// This simple example shows a [CustomNestedScrollView] whose header contains a
...
// ///
// /// It is possible with a [CustomNestedScrollView] to perform just the snapping
// /// animation without floating the app bar in and out. By not using the
// /// [CustomNestedScrollView.floatHeaderSlivers], the app bar will snap in and out
// /// without floating.
// ///
...
// /// implemented in a [CustomNestedScrollView]. These widgets take any overlapping
...
// /// e.g [CustomNestedScrollView.floatHeaderSlivers], the [SliverAppBar] will animate
...
// /// Currently, [CustomNestedScrollView] does not support simultaneously floating and
...
// /// Currently, [CustomNestedScrollView] does not support stretching the outer
...
//
//   /// The widget to show inside the [CustomNestedScrollView].
//   ///
//   /// Typically this will be [TabBarView].
//   ///
//   /// The [body] is built in a context that provides a [PrimaryScrollController]
//   /// that interacts with the [CustomNestedScrollView]'s scroll controller. Any
//   /// [ListView] or other [Scrollable]-based widget inside the [body] that is
//   /// intended to scroll with the [CustomNestedScrollView] should therefore not be
//   /// given an explicit [ScrollController], instead allowing it to default to
//   /// the [PrimaryScrollController] provided by the [CustomNestedScrollView].
//   final Widget body;
//
//   /// {@macro flutter.widgets.scrollable.dragStartBehavior}
//   final DragStartBehavior dragStartBehavior;
//
//   /// Whether or not the [CustomNestedScrollView]'s coordinator should prioritize the
...
//   ///
//   /// For sample code showing how to use this method, see the [CustomNestedScrollView]
//   /// documentation.
...
// }
//
// /// The [State] for a [CustomNestedScrollView].
// ///
// /// The [ScrollController]s, [innerController] and [outerController], of the
// /// [CustomNestedScrollView]'s children may be accessed through its state. This is
// /// useful for obtaining respective scroll positions in the [CustomNestedScrollView].
// ///
// /// If you want to access the inner or outer scroll controller of a
// /// [CustomNestedScrollView], you can get its [CustomNestedScrollViewState] by supplying a
// /// `GlobalKey<NestedScrollViewState>` to the [CustomNestedScrollView.key] parameter).
// ///
...
//   CustomNestedScrollCoordinator get coordinator => _coordinator!;
//
//   /// The [ScrollController] provided to the [ScrollView] in
//   /// [CustomNestedScrollView.headerSliverBuilder].
//   ///
//   /// This is equivalent to [CustomNestedScrollView.controller], if provided.
//   ///
...
//
//   CustomNestedScrollCoordinator? _coordinator;
//
//   @override
//   void initState() {
//     super.initState();
//     _coordinator = CustomNestedScrollCoordinator(
//       this,
//       widget.controller,
...
//
// class CustomNestedScrollCoordinator implements ScrollActivityDelegate, ScrollHoldController {
//   CustomNestedScrollCoordinator(
//       this._state,
//       this._parent,
...
//     _outerController = CustomNestedScrollController(
//       this,
//       initialScrollOffset: initialScrollOffset,
//       debugLabel: 'outer',
//     );
//     _innerController = CustomNestedScrollController(
//       this,
...
//   }
//
//   set innerController(CustomNestedScrollController value) {
...
//
//   late CustomNestedScrollController _outerController;
//   late CustomNestedScrollController _innerController;
//
...
// }
//
// class CustomNestedScrollController extends ScrollController {
//   CustomNestedScrollController(
//       this.coordinator, {
//         double initialScrollOffset = 0.0,
//         String? debugLabel,
//       }) : super(initialScrollOffset: initialScrollOffset, debugLabel: debugLabel);
//
//   final CustomNestedScrollCoordinator coordinator;
//
//   @override
...
// /// and an [NestedScrollViewViewport], to shift overlap in a [CustomNestedScrollView].
// ///
...
// /// See also:
// ///
// ///  * [CustomNestedScrollView], which uses a [NestedScrollViewViewport] and a
...
// /// See also:
// ///
// ///  * [CustomNestedScrollView], whose documentation has sample code showing how to
// ///    use this widget.
...
// /// See also:
// ///
// ///  * [CustomNestedScrollView], which uses a [SliverOverlapAbsorber] to align its
...
// }
//
// /// The [Viewport] variant used by [CustomNestedScrollView].
// ///
...
// }
//
// /// The [RenderViewport] variant used by [CustomNestedScrollView].
// ///
// /// This viewport takes a [SliverOverlapAbsorberHandle] and notifies it any time
// /// the viewport needs to recompute its layout (e.g. when it is scrolled).
